...
var gc={},hc=null;gc.m="GTM-TGGWB2P";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=18",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
...
b){return void 0===b?b:a(b)}function n(a,b){void 0!==b&&(w+="&"+a+"="+b)}var p=oa,q=X("_gaq",[],!1),t=!1,r="";void 0==c.vtp_trackerName?r="gtm"+wc()+".":""!==c.vtp_trackerName&&(r=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",xf(!0));
...
if(""!==w){var E=function(a,b,c){for(var d=b.length-1;0<=d;d--){var e=b[d].split("=");if(e[0]===a)return e[1]||"1"}for(var f=c.length-1;0<=f;f--){var h=c[f].split("=");if(h[0]===a)return h[1]||"1"}},K=S($f()),A=R(K,"query",void 0,void 0,void 0).split("&"),N=c.vtp_allowAnchor?R(K,"fragment",void 0,void 0,void 0).split("&"):[];n("gclid",E("gclid",N,A));n("gclsrc",E("gclsrc",N,A));n("dclid",E("dclid",N,A));d("_set","campaignParams",w)}l("anonymizeIp",
...
"vtp_detectTitle");void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(q.push(["_gat._forceSSL"]),t=!!c.vtp_forceSsl);d("_set","hitCallback",function(){nc(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){d("_trackEvent",String(c.vtp_eventCategory),
...
var V=function(){X("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,Xf(Y("https","http","://stats.g.doubleclick.net/dc.js",t),V,c.vtp_gtmOnFailure));else if(!a){var aa=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;Xf(Y("https://ssl","http://www",aa,t),V,c.vtp_gtmOnFailure)}})}();
...
".bizographics.com/insight.min.js");J(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)}catch(c){Q(a.vtp_gtmOnFailure)}})}();
